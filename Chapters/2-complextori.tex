...
\subsection{The Poincare-Bundle as a Biextension}
...
\end{definition}
We shall prove the following theorem next time.
\begin{theorem}
Let $L$ be a positive definite line-bundle on $X$, then, $h^0(X,L)=Pf(E)$
\end{theorem}
\end{paragraph}